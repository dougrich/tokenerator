...
export class Car extends React.PureComponent<BaseIconProperties, {}> {
  render() {
    return (
      <BaseIcon iconId="lnr-car" {...this.props}/>
    );
  }
}

IconSheet.Parts["car"] = class Markup extends React.PureComponent<{}, {}> {
  render() {
    return (
      <g id="lnr-car">
