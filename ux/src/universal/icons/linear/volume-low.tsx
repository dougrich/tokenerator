...
export class VolumeLow extends React.PureComponent<BaseIconProperties, {}> {
  render() {
    return (
      <BaseIcon iconId="lnr-volume-low" {...this.props}/>
    );
  }
}

IconSheet.Parts["volume-low"] = class Markup extends React.PureComponent<{}, {}> {
  render() {
    return (
      <g id="lnr-volume-low">
