...
export class Volume extends React.PureComponent<BaseIconProperties, {}> {
  render() {
    return (
      <BaseIcon iconId="lnr-volume" {...this.props}/>
    );
  }
}

IconSheet.Parts["volume"] = class Markup extends React.PureComponent<{}, {}> {
  render() {
    return (
      <g id="lnr-volume">
