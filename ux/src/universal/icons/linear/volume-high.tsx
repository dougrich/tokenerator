...
export class VolumeHigh extends React.PureComponent<BaseIconProperties, {}> {
  render() {
    return (
      <BaseIcon iconId="lnr-volume-high" {...this.props}/>
    );
  }
}

IconSheet.Parts["volume-high"] = class Markup extends React.PureComponent<{}, {}> {
  render() {
    return (
      <g id="lnr-volume-high">
